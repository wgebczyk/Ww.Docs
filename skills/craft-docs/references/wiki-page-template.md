...
## Module Page (`docs/craft-docs/pages/modules/{repo-module-kebab}.md`)
...
|---|---|---|---|---|---|---|
| [{Module Name}](pages/modules/{repo-module-kebab}.md) | {repo} | {style} | {N} | {N} | {N} | {Low|Medium|High} |
...
- **Module:** [{repo}-{module}](../pages/modules/{slug}.md#critical)
- **Rule:** {rule name}
- **Where:** `repo/path/file.ext:Lstart-Lend`
- **First detected:** {ISO date}
