...
description: >
  ...
  update the wiki, run a mismatch report, or invoke /tech-docs-mini. Single-repository
  variant of tech-docs: scans the current folder and below (repo root). Follows a hybrid
